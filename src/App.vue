<template>
  <div id="app">
    <block-header v-on="block_handles"></block-header>
    <block-main v-on="block_handles"></block-main>
    <block-clock v-on="block_handles"></block-clock>
    <block-cars v-on="block_handles" @chooseComp="setCar" id="#cars"></block-cars>
    <block-info v-on="block_handles"></block-info>
    <block-advantages v-on="block_handles"></block-advantages>
    <block-contacts v-on="block_handles"></block-contacts>
    <block-legal v-on="block_handles"></block-legal>
    <full-get
      v-if="show.get"
      :data="data"
      @close="closeThings"
